...
assigned: 2022-10-20 17:00
due: 2022-10-27 23:59
...
You will need to populate the "TODO" column with the issues from your
team's repo.

I'll show you how during lecture.

## Big Picture: what is team02 all about?

From a high-level standpoint, you'll be resolving these 31 issues:

Set up Tasks:

* Setting up a Repo with qa and prod deployments on Heroku (1 issue)

Coding Tasks: (6 db tables, 5 issues per database table = 30 issues)
...
| 2 | ldelplaya@ucsb.edu | s22-6pm-3 | 11 | 2022-04-20T18:31 | Heroku problems | false | 
